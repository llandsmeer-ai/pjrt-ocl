...
from . import gather_index  # noqa: F401  (general data-dependent stablehlo.gather, §38)
from . import scatter_index  # noqa: F401  (general data-dependent stablehlo.scatter, §42)
from . import reduce_window  # noqa: F401  (pooling via windowed reduction)
from . import conv  # noqa: F401  (stablehlo.convolution — direct N-D NHWC/HWIO conv, §39)
...
from . import complex_fft  # noqa: F401  (complex64 split-pair + stablehlo.fft, §43)

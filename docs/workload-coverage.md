...
**Coverage: 15/18 workloads run on our backend (83%).**  *(§39: direct N-D
convolution — cnn now PASS via OP_CONV. Remaining fails: monte_carlo
(shift_right_logical), fft (complex dtype), brax_step (platform allowlist +
gather/scatter/case/atan).)*
